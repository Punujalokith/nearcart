          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Sign in to NearCart', style: TextStyle(color: AppTheme.textSub, fontSize: 16)),
                  ...
                  child: TextButton(
                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [TextSpan(text: 'Sign up', style: TextStyle(color: AppTheme.primary, fontWeight: FontWeight.w600))],
                      ),
                    ),
                  ),
                ),
